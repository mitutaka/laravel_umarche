            ...
            <div class="md:w-1/2 ml-4">
              ...
              <div class="flex justify-around items-center">
                <div class="ml-8">
                  ...
                  <span class="text-sm text-gray-700">円(税込)
                  </span>
                </div>
                ...
                <button
                  class="flex ml-auto mr-3 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">カートに入れる
                </button>
              </div>
            </div>
          </div>
